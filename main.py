...
if not os.getenv("DEEPSEEK_API_KEY"):
    ...
    print("   Please create a .env file with: DEEPSEEK_API_KEY=sk-...")
...
def main():
    ...
    print(f"🤖 Model: DeepSeek-Chat (Brain + Critic) | Embeddings: Local (all-MiniLM-L6-v2)")
    print(f"🗄️  Data Store: Local JSON files")
